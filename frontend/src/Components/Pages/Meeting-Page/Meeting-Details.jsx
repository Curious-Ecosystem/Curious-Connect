                    ...
                    <div className='border  border-gray-400 rounded-xl px-4 w-[750px] h-auto'>
                        <div className="mt-2 w-full p-4">
                            ...
                            <div className="mb-4 w-full">
                                ...
                                <input type="text" id="url" className="w-full font-semibold border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-gray-100" value={url} />
                            </div>
                            <div className="mb-4 w-full">
                                <label htmlFor="date" className="block text-gray-100 text-sm font-semibold mb-2">Date</label>
                                <DatePicker id="date" selected={date} className="w-full font-semibold border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-gray-100" />
                            </div>
                            <div className="mb-4 w-full">
                                <label htmlFor="time" className="block text-gray-100 text-sm font-semibold mb-2">Time</label>
                                <input type="time" id="time" className="w-full font-semibold border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-gray-100" value={time} />
                            </div>
                            <div className=" w-full">
                                <label htmlFor="duration" className="block text-gray-100 text-sm font-semibold mb-2">Duration</label>
                                <select id="duration" className="w-full font-semibold border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-gray-100" value={duration}>
