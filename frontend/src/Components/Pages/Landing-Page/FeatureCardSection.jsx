...
const Feature = () => {
  return (
    <div className="my-16 flex justify-evenly items-center gap-3  lg:flex flex-wrap  ">
		 <div className="w-[250px] h-[340px] flex-col items-evenly justify-center rounded-lg border bg-white  shadow-blue-400 shadow-[0_0_6px_3px]">
      <img 
        ...
        alt="Laptop"
        className="h-[160px] w-full rounded-md object-cover border-[1px] border-black border-solid"
      />
      <div className="p-4 flex flex-col items-center justify-center">
        ...
        <button
          type="button"
          className="mt-2 rounded-lg bg-blue-600 p-[6px] w-[180px] text-[13px] font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
        >
          Read
        </button>
      </div>
    </div>
	<div className="w-[250px]  bg-white  h-[340px] rounded-lg border  shadow-blue-400 shadow-[0_0_6px_3px] lg:mt-4">
      <img
        src="https://www.ismartrecruit.com/upload/blog/main_image/Online_team_building_fun_interactive.webp"
        alt="Team work"
        className="h-[160px] w-full rounded-md object-cover border-[1px]"
      />
      <div className="p-4 flex flex-col items-center justify-center">
        ...
        <button
          type="button"
          className="mt-2 rounded-md bg-blue-600 p-[6px] w-[180px] text-[13px] font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
        >
          Read
        </button>
      </div>
    </div>
	<div className="w-[250px] h-[340px]  bg-white rounded-lg border  shadow-blue-400 shadow-[0_0_6px_3px] lg:mt-4">
      <img
	...
	<div className="w-[250px] h-[340px] flex-col items-evenly justify-center  bg-white rounded-md border  shadow-blue-400 shadow-[0_0_6px_3px] lg:mt-6">
      <img
      ...
      <div className="p-4 flex flex-col items-center justify-center">
        ...
        <p className="mt-2 text-sm text-white-600 p-1 text-gray-500">
          Enjoy seemless collaboration without compromising on privacy or security.
        </p>
        <button
          type="button"
          className="mt-2 rounded-md bg-blue-600 p-[6px] w-[180px] text-[13px] font-semibold  text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
