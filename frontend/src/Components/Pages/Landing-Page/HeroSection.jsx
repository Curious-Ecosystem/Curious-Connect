...
const HeroSection = () => {
  return (
    <div>
      <div className="justify-center tracking-wide items-center text-cyan-50 font-bold flex flex-col md:flex-row lg:pl-10 lg:pr-10 gap-2" >
        <div className="lg:w-[70%] w-full flex flex-col p-5 justify-center ">
          ...
          <h1 className="text-2xl md:text-3xl font-bold leading-tight p-2 mb-2 flex gap-2 flex-nowrap text-start">
            START{" "}
            <span className="bg-gradient2 border-[1px] border-[#0D7A9F] rounded-lg pt-0.5 pb-0.5 pr-1 pl-1 mb-">CONFERENCE</span>
          </h1>

          {/* paragraph */}
          <div>
            <p className="text-16 text-[#494F5A] md:text-lg text-start uppercase leading-5 px-3">
