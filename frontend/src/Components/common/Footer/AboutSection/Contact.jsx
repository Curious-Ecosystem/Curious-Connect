          ...
          <div className="flex items-center mb-2">
            ...
            >
              <path
                ...
                strokeWidth="2"
                d="M12 3v6m0 0v6m0-6h6m-6 0H6a6 6 0 016-6zm0 12a6 6 0 100-12 6 6 0 000 12z"
              ></path>
            </svg>
          ...
          <div className="flex items-center mb-2">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M13 10.083V3m-1 7.083a3 3 0 100-6 3 3 0 000 6zM20 14v7a2 2 0 01-2 2H6a2 2 0 01-2-2v-7m0-4h16V3H4v7a7 7 0 007 7h2a7 7 0 007-7v0z"
              ></path>
            </svg>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                name="message"
                rows="4"
                className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm border border-2 sm:text-sm border-gray-300 rounded-md"
              ></textarea>
            </div>
            <div className="mt-6">
              <button
