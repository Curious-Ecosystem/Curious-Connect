...
import { faVideo, faChartBar, faComments, faShieldAlt, faCog } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className='max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <ul className='space-y-4'>
            ...
            >
              <FontAwesomeIcon icon={faVideo} className='h-6 w-6 text-teal-400 mr-3' />
            ...
            >
              <FontAwesomeIcon icon={faChartBar} className='h-6 w-6 text-teal-400 mr-3' />
            ...
            >
              <FontAwesomeIcon icon={faComments} className='h-6 w-6 text-teal-400 mr-3' />
            ...
            >
              <FontAwesomeIcon icon={faShieldAlt} className='h-6 w-6 text-teal-400 mr-3' />
            ...
            >
              <FontAwesomeIcon icon={faCog} className='h-6 w-6 text-teal-400 mr-3' />
