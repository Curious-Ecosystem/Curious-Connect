    ...
    <div className="flex justify-center items-center px-12 py-12 max-md:px-2">
      <div className="flex lg:flex-nowrap flex-wrap flex-row gap-10 justify-between w-full max-w-[1209px] max-md:flex-wrap max-md:max-w-full">
        ...
        <div className="flex flex-col px-12 tracking-wider w-full lg:w-[500px] py-12 bg-[#1f22286f] border-[1px] border-[#868686] border-solid rounded-[20px] lg:rounded-[49px] max-md:px-5 max-md:max-w-[750px]">
          ...
          <input type='text' name='email' placeholder='Enter Your Email' className="shrink-0 mt-4 p-5 h-14 rounded-3xl bg-white"></input>
          <div className="self-start mt-4 ml-2 text-lg font-bold text-white max-md:ml-2.5">
            PASSWORD
          </div>
          <input type='password' name='password' placeholder='Enter Your Password' className="shrink-0 mt-4 p-5 h-14 rounded-3xl bg-white"></input>
          <div className="justify-center cursor-pointer hover:bg-transparent hover:border-[2px] hover:border-[#F06B48] self-center px-16 py-3 mt-8 text-2xl font-bold text-center text-white whitespace-nowrap bg-[#F06B48] rounded-full max-md:px-14 max-md:mt-10">
            Login
          </div>
          <div className="flex flex-wrap gap-4 mt-12 justify-center max-md:mx-2.5 max-md:mt-10">
