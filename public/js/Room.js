...
/**
 * CuriousConnect SFU - Room component
 *
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our CuriousConnect SFU Video Chat Meeting`;
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your CuriousConnect experience?',
    ...
    Swal.fire({
        ...
        <div id="about">
            <button 
                ...
                class="pulsate" 
                onclick="window.open('https://codecanyon.net/user/thecuriousteam')">
            ...
            Author: <a 
                ...
                href="https://in.linkedin.com/company/thecuriousorganization" target="_blank"> 
                Curious Community
            </a>
            <br /><br />
            Email:<a 
                ...
                href="mailto:info@curiousdevelopers.in?subject=CuriousConnect SFU info"> 
