...
/**
 * CuriousConnect SFU - Client component
 *
...
const image = {
    about: '../images/curiousconnect-logo.gif',
    avatar: '../images/curiousconnectsfu-logo.png',
...
class RoomClient {
    ...
    selectFileToShare(peer_id, broadcast = false) {
        ...
        Swal.fire({
            allowOutsideClick: false,
            background: swalBackground,
            imageAlt: 'curiousconnectsfu-file-sharing',
        ...
        if (isImageURL(this.incomingFileInfo.fileName)) {
            ...
            reader.onload = (e) => {
                Swal.fire({
                    ...
                    imageAlt: 'curiousconnectsfu-file-img-download',
                    showDenyButton: true,
